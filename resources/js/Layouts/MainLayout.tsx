    ...
    return (
        <div>
            ...
            <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex flex-row">
                ...
                <div className="relative bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700 h-[100vh] w-[280px] p-2">
